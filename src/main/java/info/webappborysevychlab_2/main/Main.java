package info.webappborysevychlab_2.main;

import info.webappborysevychlab_2.dao.StudentAddPartDAO;
import info.webappborysevychlab_2.dao.StudentDAO;
import info.webappborysevychlab_2.dao.StudentMainPartDAO;
...
public class Main {
    ...
    public static void main(String[] args) {
        StudentMainPartDAO studentMainPartDAO = new StudentMainPartDAO();
        StudentAddPartDAO studentAddPartDAO = new StudentAddPartDAO();
        StudentDAO studentDAO = new StudentDAO();

        resetTables();

        studentDAO.insert(firstStudent);
        studentDAO.insert(secondStudent);
        studentDAO.insert(thirdStudent);
    }
}
